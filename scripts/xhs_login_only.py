#!/usr/bin/env python3
"""Browser-only Xiaohongshu login flow that saves cookies without running a crawl job."""
...
async def run_login(repo_dir: Path, login_type: str, save_service: str, save_env: str) -> int:
    ...
    try:
        ...
        async with async_playwright() as playwright:
            ...
            print(
                "Starting Xiaohongshu login flow. Complete the login in the browser or scan the QR code if shown.",
                flush=True,
            )
